package com.example.asignyouaddress.net;
...
import com.example.asignyouaddress.view.ProgressDialog;
			...
			new AsyncTask<List<NameValuePair>, Integer, String>(){
               protected void onPreExecute() {
				...
				protected String doInBackground(List<NameValuePair>... params) {
					SDHttpClient sdClient = new com.example.asignyouaddress.net.SDHttpClient();
					String json = null;
					try {
